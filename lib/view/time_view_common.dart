...
class TimeViewCommon extends StatefulWidget {
  const TimeViewCommon({super.key});

  @override
  State<TimeViewCommon> createState() => _TimeViewCommonState();
}

class _TimeViewCommonState extends State<TimeViewCommon> {
